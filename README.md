...
jobs:
  continuous:
    ...
    - name: continuous
      run: git clone https://github.com/taishingi/continuous-template.git continuous && cd continuous/rust && ./scripts-gen "github.com" "username" "repository" "branch" "cpu" && packer validate . && packer build .
```
